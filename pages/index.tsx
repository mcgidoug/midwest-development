        ...
        <main className='bg-white text-black px-10 dark:bg-gray-900 dark:text-white md:px-20 lg:px-40'>
          ...
          <section>
            ...
            <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
              ...
              <div className='basis-1/5 flex-1 image-container' onClick={() => window.open('https://mcgidoug.github.io/il-common-core-cerc-creator/', "_blank")}><Image width={parseFloat('100%')} height={parseFloat('100%')} layout="responsive" className='rounded-lg object-cover shadow-lg' alt='portfolio image 7' src={arzet} /></div>
              <div className='basis-1/5 flex-1 image-container' onClick={() => window.open('https://mcgidoug.github.io/il-common-core-cerc-creator/', "_blank")}><Image width={parseFloat('100%')} height={parseFloat('100%')} layout="responsive" className='rounded-lg object-cover shadow-lg' alt='portfolio image 8' src={autentik} /></div>
              <div className='basis-1/5 flex-1 image-container' onClick={() => window.open('https://mcgidoug.github.io/il-common-core-cerc-creator/', "_blank")}><Image width={parseFloat('100%')} height={parseFloat('100%')} layout="responsive" className='rounded-lg object-cover shadow-lg' alt='portfolio image 9' src={easylight} /></div>
              <div className='basis-1/5 flex-1 image-container' onClick={() => window.open('https://mcgidoug.github.io/il-common-core-cerc-creator/', "_blank")}><Image width={parseFloat('100%')} height={parseFloat('100%')} layout="responsive" className='rounded-lg object-cover shadow-lg' alt='portfolio image 10' src={lupitahvac} /></div>
